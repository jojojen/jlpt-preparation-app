// prompts.ts
const sharedPrompt = `As a professional japanese tutor AI proficient in JLPT questions and having extensive experience in teaching Japanese, please create ONE test question for understanding everyday Japanese conversation, following these conditions:
